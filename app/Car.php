...
class Car extends Model
{
   ...
   */
  protected $fillable = [
      'id', 'category_id', 'name', 'model', 'model_year', 'colour', 'price', 'mileage', 'number_of_doors', 'number_of_seats', 'engine_size', 'body_style', 'description', 'fuel_type', 'gearbox_type', 'car_type', 'status', 'sale_status', 'featured_image'
  ];
}
