@extends('layouts.app')
@section('title','Enquire Part Exchange')
        ...
        <div class="row">
            <div class="offset-1 offset-sm-0 col-10 col-sm-8 col-md-6 col-lg-4 cm-bg-danger-x header-title-top py-80">
                <div class="position-r">
                    <h1>Enquire Part Exchange Your Vehicle Today</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="py-4">
    <div class="container">
        ...
        <h4><i class="fas fa-check-circle"></i> Step 1: You would like to part exchange against</h4>
        ...
        <div class="part_container">
          <h4>Step 2: Get a quote on your current car</h4>
          ...
          <form id="steps-form" class="enquire_part_exchange_form" role="form" method="post" novalidate>
            @csrf
              <section class="active step1">
                  <div class="row">
                      ...
                      <div class="form-group col-sm-6 col-md-4">
                          ...
                          <input type="hidden" name="car_model" value="{{ $car_detail->model }}">
                          <input type="hidden" name="name" value="{{ $car_detail->name }}">
                  ...
                  <div class="form-group">
                      <button type="button" class="btn btn-lg btn-danger step-next align-right">Continue to Step 2</button>
                  </div>
              </section>
...
$(document).ready(function(){
  ...
  $('.enquire_part_exchange_form').on('submit', function(event){
    event.preventDefault();

    $.ajax({
      url:"{{ url('/store_enquiry_part_exchange') }}",
      method:"POST",
